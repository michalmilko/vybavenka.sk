...
axios.post('https://endpoint.vybavenka.sk/api/users', formData)
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      <input className="menoPriezvisko" type="text" placeholder="Meno" value={MenoPriezvisko}
       ...
       `<input className="Password" placeholder="Heslo" type="password" required minLength={2} maxLength={25} value={deletePassword}
